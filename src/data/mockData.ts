...
export const mockRules: Rule[] = [
  {
    ...
    examples: ['航拍测绘', '电力巡检', '环境监测'],
    relatedPurposes: ['无人机作业', '航拍测绘', '电力巡检', '环境监测'],
  },
  {
    id: '2',
    category: '商业航拍',
    materials: ['空域使用申请表', '企业营业执照', '无人机资质证明', '拍摄方案', '第三方责任险', '拍摄许可'],
    advanceDays: 5,
    restrictions: ['限高120米', '禁飞时段08:00-10:00, 17:00-19:00', '需提前告知周边单位'],
    examples: ['商业宣传片', '影视拍摄', '活动直播'],
    relatedPurposes: ['商业航拍', '航拍测绘'],
  },
  {
    id: '3',
    category: '农业植保',
    materials: ['空域使用申请表', '农业作业资质', '无人机植保资质', '作业方案', '农药使用许可'],
    advanceDays: 2,
    restrictions: ['限高50米', '仅限白天作业', '需避开居民区'],
    examples: ['农药喷洒', '施肥作业', '作物监测'],
    relatedPurposes: ['农业植保'],
  },
  {
    id: '4',
    category: '物流配送',
    materials: ['空域使用申请表', '物流运营资质', '无人机配送资质', '配送方案', '货物保险'],
    advanceDays: 4,
    restrictions: ['限高80米', '禁飞时段12:00-14:00', '需使用指定航线'],
    examples: ['同城配送', '生鲜配送', '紧急物资运输'],
    relatedPurposes: ['物流配送'],
  },
  {
    id: '5',
    category: '直升机飞行',
    ...
    relatedPurposes: ['直升机飞行', '医疗救援', '商务飞行'],
  },
  {
    id: '6',
    category: '热气球飞行',
  ...
  },
  {
    ...
    relatedPurposes: ['科研试飞', '新机测试', '设备验证'],
  },
];
